  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, hsl(var(--background) / 1) 0%, hsl(var(--background) / 0.92) 18%, hsl(var(--background) / 0.72) 42%, hsl(var(--background) / 0.38) 68%, hsl(var(--background) / 0.10) 100%)",
        }}
      />
