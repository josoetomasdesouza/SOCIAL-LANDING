  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, hsl(var(--background) / 0.16) 0px, hsl(var(--background) / 0.38) 10px, hsl(var(--background) / 0.68) 22px, hsl(var(--background) / 0.9) 36px, hsl(var(--background)) 64px), hsl(var(--background))",
        }}
      />
