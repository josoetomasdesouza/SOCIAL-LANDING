  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, rgba(0, 128, 255, 0.92) 0%, rgba(0, 128, 255, 0.88) 28%, rgba(0, 128, 255, 0.78) 48%, rgba(0, 128, 255, 0.56) 68%, rgba(0, 128, 255, 0.22) 86%, transparent 100%)",
        }}
      />
