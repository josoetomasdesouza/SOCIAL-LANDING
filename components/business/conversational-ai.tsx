  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(0, 128, 255, 0.12) 0px, rgba(0, 128, 255, 0.32) 10px, rgba(0, 128, 255, 0.58) 22px, rgba(0, 128, 255, 0.84) 36px, rgb(0, 128, 255) 64px), rgb(0, 128, 255)",
        }}
      />
