  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, hsl(var(--background)) 0%, hsl(var(--background) / 1) 22%, hsl(var(--background) / 0.96) 40%, hsl(var(--background) / 0.78) 62%, hsl(var(--background) / 0.32) 82%, transparent 100%)",
        }}
      />
