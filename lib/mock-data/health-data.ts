...
export const healthBrand: HealthBrand = {
  ...
  specialties: ["Clinica Geral", "Cardiologia", "Dermatologia", "Nutricao", "Psicologia", "Pediatria", "Ortopedia"],
...
export const healthProfessionals: HealthProfessional[] = [
  ...
  },
  {
    ...
    bio: "Nutricionista clinica com foco em habitos alimentares sustentaveis e acompanhamento personalizado.",
    rating: 4.9,
    totalConsults: 980,
    reviewCount: 214,
    ...
    telemedicine: true,
    availability: {
      "2024-01-22": ["10:00", "11:00", "14:00", "15:00"],
      "2024-01-23": ["09:00", "10:00", "14:00", "16:00"],
      "2024-01-25": ["08:00", "09:00", "14:00", "15:00"],
    },
  },
  {
    id: "doc-5",
    ...
    crm: "567890-SP",
    avatar: "https://images.unsplash.com/photo-1582750433449-648ed127fb54?w=100&h=100&fit=crop&crop=face",
    bio: "Psicologa clinica — acolhimento e escuta em consultas presenciais e online.",
    rating: 4.8,
    totalConsults: 760,
    reviewCount: 178,
    ...
    telemedicine: true,
    availability: {
      "2024-01-22": ["13:00", "14:00", "15:00", "16:00"],
      "2024-01-24": ["09:00", "10:00", "14:00", "15:00"],
      "2024-01-25": ["13:00", "14:00", "15:00"],
    },
  },
]
...
export const healthServices: HealthService[] = [
  ...
  },
  {
    ...
    description: "Sessao de limpeza facial com orientacao dermatologica — ideal para conversar sobre rotina de cuidados",
    duration: "45 min",
    price: 280,
    professional: "Dra. Ana Oliveira",
  ...
  {
    id: "serv-7",
    name: "Avaliacao Estetica Facial",
    description: "Consulta para conversar sobre opcoes esteticas, incluindo botox e harmonizacao, com avaliacao individual",
    duration: "40 min",
    price: 420,
    professional: "Dra. Ana Oliveira",
    category: "Dermatologia",
  },
  {
    ...
    description: "Avaliacao alimentar e plano orientativo em consulta com nutricionista",
    duration: "50 min",
    price: 220,
    professional: "Dra. Juliana Ferreira",
    category: "Nutricao",
  },
  {
    id: "serv-9",
    name: "Sessao de Psicologia",
    description: "Espaco de escuta e acolhimento — presencial ou online",
    duration: "50 min",
    price: 280,
